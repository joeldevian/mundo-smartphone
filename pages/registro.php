...
$fecha2 = date("Y-m-d");
    ...
    if (isset($_GET['lista'])) {
        $x1 = isset($_GET['codigo']) ? $_GET['codigo'] : null;
	                ...
	                <div class="box">
	                    <div class="box-header">
	                        <center>
	                            <div class="box-header">
	                                <h3>
	                                    <center>Imprimir Lista De Clientes</a></center>
	                                </h3>
	                            </div>
	            ...
	            <!-- general form elements -->
	                <div class="box box-primary">
	                    ...
	                    <div class="box-body">
                            <div class="form-group">
                                <label for="exampleInputFile">Nombre</label>
                                <input onkeypress="return caracteres(event)" onblur="this.value=this.value.toUpperCase();" type="text" required name="nombre" class="form-control" value="<?php echo $fila['nombre']; ?>" id="exampleInputEmail1" placeholder="Introducir el Nombre">
                                
                                <label for="exampleInputFile">Apellido</label>
                                <input onkeypress="return caracteres(event)" onblur="this.value=this.value.toUpperCase();" required type="text" name="apellido" class="form-control" value="<?php echo $fila['apellido']; ?>" id="exampleInputEmail1" placeholder="Apellido">
                                
                                <label for="exampleInputFile">Cédula</label>
                                <input onkeydown="return enteros(this, event)" required type="text" name="ci" class="form-control" value="<?php echo $fila['cedula']; ?>" id="exampleInputEmail1" placeholder="Cédula">
                                ...
                                <input required type="text" name="direccion" class="form-control" value="<?php echo $fila['direccion']; ?>" id="exampleInputEmail1" placeholder="Dirección">
