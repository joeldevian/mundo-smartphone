            ...
            <div class="box">
                <div class="box-header">
                    <center>
                        <div class="box-header">
                            <h3>
                                <center>Imprimir Lista De equipos en taller</a></center>
                            </h3>
                        </div>
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            <td><h3>Correo</h3></td>
                                            <td><?php echo $fila['correo']; ?></td> <!-- Asegúrate de que 'correo' esté en la consulta -->
                                        </tr>
                                    </table>
                                    ...
                                    <center>
                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $fila['descripcion_p']; ?></td>
                                            </tr>
                                            <tr>
                                                <td><h3>Marca</h3></td>
