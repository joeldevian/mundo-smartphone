...
if (isset($_GET['nuevo'])) {
    $var1 = ''; // Inicializa var1
    $var2 = ''; // Inicializa var2
    $var3 = ''; // Inicializa var3
                ...
                <div class="box">
                    <div class="box-header">
                        <center>
                            <div class="box-header">
                                <h3>
                                    <center>Imprimir Lista De Equipos y Accesorios</a></center>
                                </h3>
                            </div>
