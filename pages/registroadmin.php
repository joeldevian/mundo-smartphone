            ...
            <form role="form" name="fe" action="?mod=registroadmin&nuevo=nuevo" method="post">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input required type="text" name="usuario" class="form-control" value="<?php echo $var3 ?>" id="exampleInputEmail1" placeholder="Usuario">
...
if (isset($_GET['lista'])) {
    ...
    if (isset($_POST['lista'])) {
        $x2 = isset($_POST['lista']) ? $_POST['lista'] : null;
    }
    ?>
        <div class="row">
            <div class="col-xs-8">
                                ...
                                if ($tipo2 == 1) {
                                    ...
                                    while ($fila = $bd->mostrar_registros()) {
                                        if (isset($fila['status'])) {
                                            ...
                                            $btn_st = "default"; // Valor predeterminado si 'status' no está definido
                                            $txtFuncion = "Sin estado";
                                        }
            ...
            ?>
                <div class="col-md-10">
                    ...
                    <div class="box box-primary">
                        ...
                        echo
                        '
                <form role="form"  name="fe" action="?mod=registroadmin&editar=editar&codigo=' . $x1 . '" method="post">';
                        ?>
                        <div class="box-body">
                            <div class="form-group">
                                <label for="exampleInputFile">Nombre</label>
                                ...
                                <label for="exampleInputFile">Usuario</label>
                                <input required type="text" name="usuario" class="form-control" value=" <?php echo $fila['usuario'] ?>" id="exampleInputEmail1" placeholder="Usuario">
                                <label for="exampleInputFile">correo</label>
                ...
                while ($fila = $bd->mostrar_registros()) {
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="box box-primary">
                            ...
                            <?php
                            echo '  
                <form role="form"  name="fe" action="?mod=registroadmin&eliminar=eliminar&codigo=' . $x1 . '" method="post">';
                            ?>
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="exampleInputFile">Nombre</label>
