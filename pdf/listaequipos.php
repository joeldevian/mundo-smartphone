...
$mipdf->SetFont('ARIAL', 'B', 9);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(25, 11, "Precio Publico", 1, 0, 'C', true);



$mipdf->SetFont('ARIAL', 'B', 9);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(27, 11, "Marca", 1, 0, 'C', true);
$mipdf->SetFont('ARIAL', 'B', 9);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(20, 11, "Estado/E", 1, 0, 'C', true);
$mipdf->SetFont('ARIAL', 'B', 9);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(24, 11, "Cantidad", 1, 0, 'C', true);
...
while ($datos = $bd->mostrar_registros($sql2)) {
	...
	$mipdf->Cell(27, 5, "$marca", 1, 0, 'C');
	$mipdf->Cell(20, 5, "$estado", 1, 0, 'C');
	...
	$mipdf->Cell(24, 5, "$cantidad", 1, 0, 'C');
