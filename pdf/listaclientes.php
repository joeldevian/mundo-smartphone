...
$mipdf->Ln(2);
$mipdf->Cell(200, 10, "Lista De Clientes $fecha", 0, 0, 'C');
$mipdf->Ln(10);
...
$mipdf->SetFont('ARIAL', 'B', 9);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(35, 11, "Cedula", 1, 0, 'C', true);
$mipdf->SetFont('ARIAL', 'B', 9);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(30, 11, "Nombre", 1, 0, 'C', true);
...
$mipdf->SetFont('ARIAL', 'B', 9);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(60, 11, "correo", 1, 0, 'C', true);
...
while ($datos = $bd->mostrar_registros($sql2)) {
	...
	$mipdf->Cell(30, 5, "$apellidos", 1, 0, 'C');
	$mipdf->Cell(60, 5, "$p", 1, 0, 'C');
