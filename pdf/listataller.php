...
$mipdf->Ln(2);
$mipdf->Cell(200, 10, "Lista De Equipos $fecha", 0, 0, 'C');
$mipdf->Ln(10);
...
$mipdf->SetFont('ARIAL', 'B', 9);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(35, 11, "Tipo /Equipo", 1, 0, 'C', true);
$mipdf->SetFont('ARIAL', 'B', 9);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(30, 11, "Modelo", 1, 0, 'C', true);

$mipdf->SetFont('ARIAL', 'B', 9);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(25, 11, "Marca", 1, 0, 'C', true);



$mipdf->SetFont('ARIAL', 'B', 9);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(27, 11, "N° SERIE", 1, 0, 'C', true);
$mipdf->SetFont('ARIAL', 'B', 9);
$mipdf->SetFillColor(0, 191, 255);
$mipdf->Cell(45, 11, "FALLA", 1, 0, 'C', true);
...
$sql = "SELECT * FROM taller where id_taller";
...
while ($datos = $bd->mostrar_registros($sql2)) {
	...
	$mipdf->Cell(35, 5, "$tipo", 1, 0, 'C');
	$mipdf->Cell(30, 5, "$nombre", 1, 0, 'C');
	$mipdf->Cell(25, 5, "$marca", 1, 0, 'C');
	...
	$mipdf->Cell(27, 5, "$num2", 1, 0, 'C');
	$mipdf->Cell(45, 5, "$estado", 1, 0, 'C');
